...
VITA_CG_DIR = "ux0:/data/dungeon-hunter-2/cg"
    ...
    if descargar_dmp in ['s', 'y', 'si', 'yes']:
        ...
        try:
            ...
            if latest_dmp:
                ...
                local_dmp_name = os.path.join(logs_folder, f"DungeonHunter2-{latest_dmp}")
...
def download_glsl_shaders():
    ...
    vita_glsl_dir = "ux0:/data/dungeon-hunter-2/glsl"
    project_root = os.path.dirname(BASE_DIR)
...
VITA_GAME_DATA_DIR = "/ux0:/data/dungeon-hunter-2/data"
LOCAL_DATA_REFERENCE_DIR = "com.gameloft.android.GAND.GloftD2SS/files/data"
