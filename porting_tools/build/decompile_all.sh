...
APK_FILE="${BASE_DIR}/Dungeon-Hunter-2-HD-v1-0-2.apk"
LIB_DIR="${BASE_DIR}/Dungeon-Hunter-2-HD-v1-0-2/lib"
...
if command -v jadx >/dev/null 2>&1; then
  ...
  docker run --rm -v "${BASE_DIR}:/app" ubuntu:latest bash -c "
    ...
    ./jadx/bin/jadx -d /app/decompiled/apk_jadx /app/Dungeon-Hunter-2-HD-v1-0-2.apk
  "
fi
