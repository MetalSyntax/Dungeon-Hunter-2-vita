...
int uname(struct fake_utsname *buf) {
    if (!buf) return -1;
    strncpy(buf->sysname, "Linux", sizeof(buf->sysname));
    strncpy(buf->nodename, "vita", sizeof(buf->nodename));
    strncpy(buf->release, "3.4.0", sizeof(buf->release));
    strncpy(buf->version, "#1", sizeof(buf->version));
    strncpy(buf->machine, "armv7l", sizeof(buf->machine));
    return 0;
}
...
so_default_dynlib default_dynlib[] = {
        ...
        { "glDepthRangef", (uintptr_t)&glDepthRangef_soloader },
        ...
        { "glMapBuffer", (uintptr_t)&glMapBufferOES },
        ...
        { "glUnmapBuffer", (uintptr_t)&glUnmapBufferOES },
        ...
        { "glVertexAttrib4f", (uintptr_t)&glVertexAttrib4f_soloader },
        { "glVertexAttrib4fv", (uintptr_t)&glVertexAttrib4fv_soloader },
        ...
        { "__aeabi_dcmpun", (uintptr_t)&__aeabi_dcmpun },
