...
VITASDK_BIN = os.environ.get("VITASDK", os.path.expanduser("~/vitasdk")) + "/bin"
...
VITA_PARSE_CORE_DIR = os.environ.get("VITA_PARSE_CORE_DIR", os.path.expanduser("~/vita-tools/vita-parse-core"))
